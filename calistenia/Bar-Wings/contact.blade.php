            ...
            <div class="container-fluid">
                <div class="menu-wrapper d-flex align-items-center justify-content-between">
                    ...
                    <div class="main-menu f-right d-none d-lg-block">
                        <nav class="style color">
                            <ul id="navigation">
                                <li><a href="{{ route('index') }}">Home</a></li>
                                <li><a href="{{ route('about') }}">Sobre</a></li>
                                <li><a href="{{ route('courses') }}">Aulas</a></li>
                                <li><a href="{{ route('pricing') }}">Preços</a></li>
                                <!-- <li><a href="gallery.html">Galeria</a></li>-->
                                <li><a href="{{ route('about') }}">Noticiario</a>
                                    <ul class="submenu">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap hero-cap2 pt-70">
                                <h2 style="color: #00a2ff;">Entra em Contacto</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-3 offset-lg-1">
                            <div class="media contact-info">
                                ...
                                <div class="media-body">
                                    <h3>Pavilhão Rainha do Leonor .</h3>
                            ...
                            <div class="media contact-info">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>Manda mensagem em caso de duvida</p>
                                </div>
                            </div>
                        </div>
                    </div>
