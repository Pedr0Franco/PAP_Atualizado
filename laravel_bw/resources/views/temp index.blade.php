                ...
                <div class="container-fluid">
                    <div class="menu-wrapper d-flex align-items-center justify-content-between">
                        ...
                        <div class="header-btns d-none d-lg-block f-right">
                            <a href="contact.html" class="btn">Entra em Contacto</a>
                        </div>
                        <!-- Mobile Menu -->
                        <div class="col-12">
            ...
            <div class="container-fluid ">
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img big-img"
                                style="background-image: url(assets/img/gallery/Iuri.png);"></div>
                            <div class="overlay">
                    ...
                    <div class="modal fade" id="modaliuri" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role=ument">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img big-img"
                                style="background-image: url(assets/img/gallery/diogo.png);"></div>
                            <div class="overlay">
                                <div class="overlay-content">
                                    <p>Treinador</p>
                                    <h3>Diogo Miguel</h3>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img big-img"
                                style="background-image: url(assets/img/gallery/andre.png);"></div>
                            <div class="overlay">
                                <div class="overlay-content">
                                    <p>Treinador</p>
